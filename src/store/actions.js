...
export const CLEAR_EQUIPMENT_TYPES = 'clear_equipment_types';
...
export const SET_LOAD_TYPES_ERROR = 'set_load_types_error';
export const CLEAR_LOAD_TYPES_ERROR = 'clear_load_types_error';
